          ...
          <Grid container spacing={1}>
            <Grid item xs={6}>
              ...
              <Typography
                ...
                color="text.secondary"
              >
                <div className="font">(587)-436-7497</div>
              </Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography align="right">
                <IconButton
                  color="primary"
                  onClick={() =>
                    window.open("https://www.facebook.com/siddchopp")
                  }
                  size="large"
                >
                  <div>
                ...
                <IconButton
                  color="primary"
                  onClick={() =>
                    window.open("https://www.linkedin.com/in/sidchopp/")
                  }
                  size="large"
                >
                  <div>
